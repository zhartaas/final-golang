...
func (c *userServiceClient) CreateUser(ctx context.Context, in *RegisterUserRequest, opts ...grpc.CallOption) (*RegisterUserResponse, error) {
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *RegisterUserRequest) (*RegisterUserResponse, error) {
